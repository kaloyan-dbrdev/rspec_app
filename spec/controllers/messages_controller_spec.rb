...
describe MessagesController do
  ...
  describe "GET #index" do
    it "populates an array of messages" do
      ...
      get :index
      # use "eq" if the order in the array also matters
  ...
  describe "POST #create" do
    ...
    context "with invalid attributes" do
      it "does not save the message in the database" do
        expect {
  ...
  describe "PUT #update" do
    before :each do
      @message = create(:message, name: "Joe Sumner", email: "joe@example.com")
    end
    ...
    context "valid attributes" do
      it "changes @message's attributes" do
        put :update, id: @message,
          message: attributes_for(:message, name: "Aaron Sumner")
        @message.reload
        expect(@message.name).to eq "Aaron Sumner"
      end
    ...
    context "invalid attributes" do
      it "does not change @message's attributes" do
        put :update, id: @message,
          message: attributes_for(:message, name: "Aaron Sumner", email: nil) 
        @message.reload
        expect(@message.name).to eq "Joe Sumner"
      end
...
=begin
  # OLD AUTOMATICALLY GENERATED TESTS
  describe "GET index" do
